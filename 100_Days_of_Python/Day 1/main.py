...
I will make sure to spend some time every day coding along, for a minimum of 60 minutes a day.
...
print("I am feeling 😊")
print("You can follow my progress at replit.com/@justinaudofia")
